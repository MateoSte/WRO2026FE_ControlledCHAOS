...
def Ocitaj_crvenu():
    """
    Reads red color data from the connected phone via AppData.
    Updates the global 'red_data' variable.
    """
    global red_data
    red_data   = (0, 0, 0, 0) # x, y, width, height
    # --- Read red ---
...
def Ocitaj_zelenu():
    """
    Reads green color data from the connected phone via AppData.
    Updates the global 'green_data' variable.
    """
    # --- Read green ---
    global green_data
    green_data = (0, 0, 0, 0) # x, y, width, height
...
def obilaziZelena():
    """
    Logic for the robot to avoid a green object based on the detected green color data.
    """
    Ocitaj_zelenu()
    global green_data
    xg,yg,wg,hg = green_data
