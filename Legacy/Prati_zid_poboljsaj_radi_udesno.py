...
def okrenutLijevo():
    ...
    for i in range(11):
        ...
        while check_target<3:
            ...
            steer.run_target(300, 0)
            wait(10)
            if front_sensor.distance() <= wall:
                check_target+=1
            else: check_target = 0
            print("check", check_target, i, front_sensor.distance(), hub.imu.heading())
...
def okrenutDesno():
    ...
    for i in range(11):
        ...
        while check_target<3:
            ...
            print("check", check_target, i, front_sensor.distance())

        hub.speaker.beep()
        print("---", front_sensor.distance(), i)
        # gumb()
        car.straight(st)
        car.turn_radius(90, -turn_r)
